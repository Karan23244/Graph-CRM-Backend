  ...
  try {
    ...
    const query = `
      INSERT INTO campaign_uploads (
        ...
        advertising_id, idfa, user_agent,
        device_model, install_time, media_source
      ) VALUES ?
    `;
